package xyz.skynetcloud.cyberx.world.generation.generators;
...
{
	public static final IBlockState LOG = Blocks.LOG2.getDefaultState();
	public static final IBlockState LEAF = Blocks.LEAVES2.getDefaultState();
