package xyz.skynetcloud.cyberx.world.chunks;
...
public class ChunkGeneratorNetherTemplate implements IChunkGenerator
{
    ...
    protected static final IBlockState MAIN_BLOCK = BlockInit.DARKBLOCK.getDefaultState();
                                ...
                                if (i1 == -1)
                                {
                                    ...
                                    else if (j1 >= i - 4 && j1 <= i + 1)
                                    {
                                        ...
                                        if (flag)
                                        {
                                            ...
                                            iblockstate1 = OTHER_BLOCK3;
                                            iblockstate1 = OTHER_BLOCK4;
                                            iblockstate1 = OTHER_BLOCK5;
                                        }
                                    }
