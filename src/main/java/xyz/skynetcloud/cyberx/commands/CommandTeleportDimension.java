package xyz.skynetcloud.cyberx.commands;
...
import xyz.skynetcloud.cyberx.commands.util.CustomTeleporter;

public class CommandTeleportDimension extends CommandBase
{
	private final List<String> aliases = Lists.newArrayList(Main.MODID, "TP", "tp", "tpdim", "tpdimension", "teleport");
